...
[30.12.2025] Zrobiłem pierwszą wersję bazy danych, myślę że można już coś z tym kombinować. Dane o lotniskach i lotach są w folderze db/base_data . Jeśli chcecie pobrać nowe dane, najpierw uruchomcie plik api_request.py, a potem główną aplikację (napiszcie na messengerze po kod do api). W razię wątpliwości śmiało piszcie pytania. (P.S. - do zobaczenia wartości w pliku .db polecam DB Browser for SQLite) -- Maciek
